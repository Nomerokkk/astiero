...
include '../templates/header.php'; ?>
    ...
    <div class="wrapper panel j-wrapper">
        <section class="admin start">
            <div class="container">
                        ...
                        <div class="tabs j-tabs">
                            ...
                            ?>
                                <div class="tabs__item">
                                    <div class="tabs__item-title <?= $class; ?>" data-tab="#tab<?= $count; ?>">
                                        <?= $item['title']; ?>
                                    </div>
                                </div>
                            <? } ?>
                ...
                <!-- Page 1 -->
                <div class="start__tab-area j-tabs-area" id="tab1">
                    <div class="start__bl">
                ...
                <!-- Page 2 -->
                <div class="start__tab-area j-tabs-area" id="tab2">
                    <div class="start__bl">
                        <div class="start__inner">
                            <div class="admin__row">
                                <div class="admin__col admin__col--full">
                ...
                <!-- Page 3 -->
                <div class="start__tab-area j-tabs-area" id="tab3">
                    <div class="start__bl">
                        <div class="start__inner">
                            <div class="admin__row">
                                <div class="admin__col admin__col--full">
                ...
                <!-- Page 4 -->
                <div class="start__tab-area j-tabs-area" id="tab4">
                    <div class="start__bl">
                        <div class="start__inner">
                            <div class="admin__row">
                                <div class="admin__col admin__col--full">
                ...
                <!-- Page 5 -->
                <div class="start__tab-area j-tabs-area" id="tab5">
                    <div class="start__bl">
                        <div class="start__inner">
                            <div class="admin__row">
                                <div class="admin__col admin__col--full">
                ...
                <!-- Page 6 -->
                <div class="start__tab-area j-tabs-area" id="tab6">
                    <div class="start__bl">
                        <div class="start__inner">
                            <div class="admin__row">
                                <div class="admin__col admin__col--full">
                ...
                <!-- Page 7 -->
                <div class="start__tab-area j-tabs-area" id="tab7">
                    <div class="start__bl">
                        <div class="start__inner">
                            <div class="admin__row">
                                <div class="admin__col admin__col--full">
                ...
                <!-- Page 8 -->
                <div class="start__tab-area j-tabs-area" id="tab8">
                    <div class="start__bl">
                        <div class="start__inner">
                            <div class="admin__row">
                                <div class="admin__col admin__col--full">
    ...
    <div class="modal modal--remove" id="ok-remove" data-tooltip="Удалить">
